...
final class BitmapUtils {
    ...
    static RotateBitmapResult rotateBitmapByExif(Bitmap bitmap, Context context, Uri uri) {
        ...
        return ei != null ? rotateBitmapByExif(bitmap, ei) : new BitmapUtils.RotateBitmapResult(bitmap, 0);
    }
     ...
     * New bitmap is created and the old one is recycled.
     */
    static BitmapUtils.RotateBitmapResult rotateBitmapByExif(Bitmap bitmap, ExifInterface exif) {
        int degrees;
        int orientation =
        ...
        return new BitmapUtils.RotateBitmapResult(bitmap, degrees);
    }
