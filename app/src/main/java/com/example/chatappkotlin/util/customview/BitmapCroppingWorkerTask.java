...
final class BitmapCroppingWorkerTask
        ...
        try {
            if (!isCancelled()) {
                ...
                if (mUri != null) {
                    ...
                    return new BitmapCroppingWorkerTask.Result((Bitmap) null, 1);
                }
                ...
                if (mSaveUri == null) {
                    return new BitmapCroppingWorkerTask.Result(bitmap, bitmapSampled.sampleSize);
                } else {
            ...
            return new BitmapCroppingWorkerTask.Result(e, mSaveUri != null);
        }
    }
     ...
     */
    @Override
    protected void onPostExecute(BitmapCroppingWorkerTask.Result result) {
        if (result != null) {
