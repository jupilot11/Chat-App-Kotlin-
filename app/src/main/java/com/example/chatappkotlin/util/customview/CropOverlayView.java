...
public class CropOverlayView extends View {
    ...
    public void setCropWindowChangeListener(CropOverlayView.CropWindowChangeListener listener) {
    ...
    public boolean setMultiTouchEnabled(boolean multiTouchEnabled) {
        if (mMultiTouchEnabled != multiTouchEnabled) {
            ...
            if (mMultiTouchEnabled && mScaleDetector == null) {
                mScaleDetector = new ScaleGestureDetector(getContext(), new CropOverlayView.ScaleListener());
            }
            return true;
        }
        return false;
